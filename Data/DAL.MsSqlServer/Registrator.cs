...
namespace DAL.MsSqlServer
{
	...
	{
		public static IServiceCollection AddKhardoUsersDbSqlServer(this IServiceCollection services, string ConnectionString)
		{
		...
		public static IServiceCollection AddKhardoDbSqlServer(this IServiceCollection services, string ConnectionString)
		{
			services.AddDbContext<ApplicationDbContext>(opt => opt
				.UseSqlServer(
					ConnectionString,o  => o.MigrationsAssembly(typeof(Registrator).Assembly.FullName)));
			return services;
		}
	}
}